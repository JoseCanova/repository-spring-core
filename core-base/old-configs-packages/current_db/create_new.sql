...
create table ArtistCreditName (artist_credit_name_join_phrase TEXT NOT NULL DEFAULT '', name VARCHAR NOT NULL not null, id int8 not null, artistid int8, artist_credit_id int8, primary key (id));
