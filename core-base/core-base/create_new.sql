...
create table area (area_id int8 not null, gid UUID NOT NULL not null, name VARCHAR NOT NULL not null, id int8 not null, areaType_id int8 not null, primary key (id));
...
create table artist (artist_id int8 not null, gid UUID NOT NULL not null, name VARCHAR NOT NULL not null, id int8 not null, artistType_id int8 not null, primary key (id));
...
create table ArtistCreditName (artist_credit_name_id int8 not null, artist_credit_name_join_phrase varchar(255), name VARCHAR NOT NULL not null, id int8 not null, artistid int8, artist_credit_id int8, primary key (id));
...
create table medium_format (description varchar(4000), gid uuid not null, hasDiscId varchar(6) not null, name VARCHAR NOT NULL not null, parent int8, year int4, id int8 not null, primary key (id));
...
create table recording (gid UUID NOT NULL not null, name VARCHAR NOT NULL not null, recording_id int8 not null, id int8 not null, artist_credit_id int8, recordingLength_id int8, primary key (id));
