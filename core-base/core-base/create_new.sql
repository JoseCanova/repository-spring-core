...
create table AreaComment (id int8 not null, comment VARCHAR NOT NULL not null, primary key (id))
create table artist (id int8 not null, artist_id int8 not null, name VARCHAR NOT NULL not null, gid UUID NOT NULL not null, artistType_id int8 not null, primary key (id))
create table artist_alias (id int8 not null, artist_alias_id int8 not null, name VARCHAR NOT NULL not null, primary key (id))
...
create table artist_credit (id int8 not null, artist_credit_id int8 not null, name VARCHAR NOT NULL not null, primary key (id))
...
create table ArtistComment (id int8 not null, comment VARCHAR NOT NULL not null, primary key (id))
create table ArtistCreditedName (id int8 not null, artist_credit_name_join_phrase TEXT DEFAULT '', name VARCHAR NOT NULL not null, artistid int8, artist_credit_id int8, primary key (id))
...
create table base_type (table_id VARCHAR NOT NULL not null, id int8 not null, gid UUID NOT NULL not null, name VARCHAR NOT NULL not null, childOrder int8, parent int8, type_id int8 not null, primary key (id))
create table base_type_description_join (description_id int8, base_type_id int8 not null, primary key (base_type_id))
create table begin_dates (class_name VARCHAR NOT NULL not null, id int8 not null, day SMALLINT NOT NULL not null, month SMALLINT NOT NULL not null, year SMALLINT NOT NULL not null, primary key (id))
...
create table end_dates (class_name VARCHAR NOT NULL not null, id int8 not null, end_day SMALLINT NOT NULL not null, end_month SMALLINT NOT NULL not null, end_year SMALLINT NOT NULL not null, primary key (id))
create table instrument (id int8 not null, gid UUID NOT NULL not null, instrument_id int8 not null, name VARCHAR NOT NULL not null, instrumentType_id int8 not null, primary key (id))
...
create table language (id int8 not null, frequency int8, isoCode1 varchar(2), isoCode2B varchar(3), isoCode2T varchar(3), isoCode3 varchar(3), language_id int8, name varchar(100) not null, primary key (id))
...
create table medium_format (id int8 not null, description varchar(4000), hasDiscId varchar(6) not null, gid uuid not null, medium_format_id int8 not null, name VARCHAR NOT NULL not null, parent int8, year int4, primary key (id))
...
create table RecordingComment (id int8 not null, comment VARCHAR NOT NULL not null, primary key (id))
...
create table release_alias (id int8 not null, relase_alias_id int8 not null, name VARCHAR NOT NULL not null, release_id int8 not null, type_id int8 not null, primary key (id))
...
create table release_group (id int8 not null, gid UUID NOT NULL not null, release_group_id int8 not null, name VARCHAR NOT NULL not null, artist_credit_id int8 not null, type_id int8, primary key (id))
...
create table release_label (id int8 not null, release_label_id int8 not null, release_id int8 not null, primary key (id))
...
create table ReleaseComment (id int8 not null, comment VARCHAR NOT NULL not null, primary key (id))
create table ReleaseGroupComment (id int8 not null, comment VARCHAR NOT NULL not null, primary key (id))
...
create table track (id int8 not null, gid UUID NOT NULL, track_id int8, name VARCHAR NOT NULL, artistCredit_id int8 not null, medium_id int8 not null, recordingId int8 not null, primary key (id))
...
create table TrackLength (id int8 not null, length int8 not null, primary key (id))
