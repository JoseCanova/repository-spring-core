...
create table ArtistCreditedName (id int8 not null, artist_credit_name_join_phrase TEXT NOT NULL DEFAULT '', name VARCHAR NOT NULL not null, artistid int8, artist_credit_id int8, primary key (id))
...
create table release_label (id int8 not null, release_label_id int8 not null, primary key (id))
...
create table releaselable_label_join (label_id int8, release_label_id int8 not null, primary key (release_label_id))
