...
create table artist_gender_join (gender_id int8 not null, artist_id int8 not null, primary key (gender_id, artist_id))
...
alter table artist_gender_join add constraint UK_c56xldlgasyd8dhw5j8odan8m unique (artist_id)
