...
create table area (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, area_id int8 not null, id int8 not null, areaType_id int8 not null, primary key (id))
...
create table AreaComment (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, comment VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table AreaEndDate (id int8 not null, primary key (id))
create table AreaType (id int8 not null, area_id int8, primary key (id))
create table artist (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, artist_id int8 not null, id int8 not null, artistType_id int8 not null, primary key (id))
create table artist_alias (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, artist_alias_id int8 not null, id int8 not null, primary key (id))
...
create table artist_credit (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, artist_credit_id int8 not null, id int8 not null, primary key (id))
...
create table ArtistComment (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, comment VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table ArtistCreditCount (id int8 not null, primary key (id))
create table ArtistCreditName (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, artist_credit_name_id int8 not null, artist_credit_name_join_phrase varchar(255), id int8 not null, artistid int8, artist_credit_id int8, primary key (id))
create table ArtistCreditNamePosition (id int8 not null, primary key (id))
...
create table bar_code_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, bar_code varchar(255) not null, id int8 not null, primary key (id))
create table base_type (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, childOrder int8, parent int8, type_id int8 not null, id int8 not null, primary key (id))
...
create table begin_dates (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, day SMALLINT NOT NULL not null, month SMALLINT NOT NULL not null, year SMALLINT NOT NULL not null, id int8 not null, primary key (id))
create table description_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, description VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table end_dates (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, end_day SMALLINT NOT NULL not null, end_month SMALLINT NOT NULL not null, end_year SMALLINT NOT NULL not null, id int8 not null, primary key (id))
create table Gender (id int8 not null, primary key (id))
create table instrument (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, instrument_id int8 not null, id int8 not null, instrumentType_id int8 not null, primary key (id))
...
create table InstrumentComment (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, comment VARCHAR NOT NULL not null, id int8 not null, primary key (id))
...
create table isrc (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, ISRC varchar(255), ISRC_ID int8, RECORDING_ID int8, SOURCE varchar(255), id int8 not null, primary key (id))
create table label (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, beginDateDay varchar(255), beginDateMonth varchar(255), beginDateYear varchar(255), country varchar(255), endDateDay varchar(255), endDateMonth varchar(255), endDateYear varchar(255), ipiCode varchar(255), labelCode varchar(255), labelId int8, sortName int8, type varchar(255), id int8 not null, primary key (id))
create table language (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, frequency int8, isoCode1 varchar(2), isoCode2B varchar(3), isoCode2T varchar(3), isoCode3 varchar(3), language_id int8, id int8 not null, primary key (id))
create table locale_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, locale VARCHAR NOT NULL, id int8 not null, primary key (id))
create table long_count_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, count int8 not null, id int8 not null, primary key (id))
create table long_number_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, number int8 not null, id int8 not null, primary key (id))
create table long_position_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, position int8 not null, id int8 not null, primary key (id))
create table LongIdSortName (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, sort_name VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table Medium (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, medium_id int8, id int8 not null, medium_format_id int8, release_id int8 not null, primary key (id))
create table medium_count_join (position_id int8 not null, medium_id int8 not null, primary key (medium_id))
create table medium_format (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, description varchar(4000), hasDiscId varchar(6) not null, parent int8, year int4, id int8 not null, primary key (id))
...
create table recording (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, recording_id int8 not null, id int8 not null, artist_credit_id int8, recordingLength_id int8, primary key (id))
create table recording_lengthy_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, length int8 not null, id int8 not null, primary key (id))
create table RecordingAlias (begin_date_day int4, begin_date_month int4, begin_date_year int4, end_date_day int4, end_date_month int4, end_date_year int4, locale varchar(1000), recording_alias_id int8, id int8 not null, recording_id int8 not null, recording_type_id int8, primary key (id))
...
create table release_alias (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, relase_alias_id int8 not null, id int8 not null, release_id int8 not null, type_id int8 not null, primary key (id))
...
create table release_group (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, release_group_id int8 not null, id int8 not null, artist_credit_id int8 not null, type_id int8, primary key (id))
create table release_group_primary_type (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table release_packaging (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, release_packaging_id int8 not null, id int8 not null, primary key (id))
create table release_status (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, release_status_id int8 not null, id int8 not null, primary key (id))
...
create table ReleaseComment (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, comment VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table sequence_long_base (id int8 not null, primary key (id))
create table sort_name_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, sort_name VARCHAR NOT NULL not null, id int8 not null, primary key (id))
create table string_number_base (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, number VARCHAR NOT NULL, id int8 not null, primary key (id))
create table track (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, track_id int8, id int8 not null, artistCredit_id int8 not null, medium_id int8 not null, recordingId int8 not null, primary key (id))
...
create table TrackLength (gid VARCHAR(50) NOT NULL not null, name VARCHAR NOT NULL not null, length int8 not null, id int8 not null, track_id int8 not null, primary key (id))
...
alter table AreaType add constraint FK280yi5mnpoghpxucwbgap4yi1 foreign key (area_id) references area
...
alter table artist_credit_name_position_join add constraint FKkkhaudkck8jj9ubgmovu68236 foreign key (position_id) references ArtistCreditNamePosition
alter table artist_credit_name_position_join add constraint FK4mnh6d6ipaf6vfjdkgebn0s3l foreign key (artist_credit_name) references ArtistCreditName
...
alter table ArtistCreditName add constraint FKlf3yjsec0ngp79ie1qtnvuyse foreign key (artistid) references artist
alter table ArtistCreditName add constraint FK11s4o0pn3k4a4wm0m0bfo5qgm foreign key (artist_credit_id) references artist_credit
alter table ArtistCreditName add constraint FKsq0uxlsxa8yf00p8hi1qaa9oh foreign key (id) references sequence_long_base
alter table ArtistCreditNamePosition add constraint FK10nsv6tlv8aclydauspgubqcf foreign key (id) references long_position_base
...
alter table label add constraint FKsxjf1yf4dcui831x1hhgfw1d6 foreign key (id) references sequence_long_base
...
alter table medium_count_join add constraint FKb9cwxy086ljxuf2076rsw54ot foreign key (position_id) references MediumCount
