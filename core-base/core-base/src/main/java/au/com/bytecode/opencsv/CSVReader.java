...
public class CSVReader implements Closeable {
     ...
     */
    public CSVReader(Reader reader, Character separator) {
     ...
     */
    public CSVReader(Reader reader, Character separator, Character quotechar) {
     ...
     */
    public CSVReader(Reader reader, Character separator, Character quotechar, Boolean strictQuotes) {
   ...
   /**
    ...
    public CSVReader(Reader reader, Character separator,
    		Character quotechar, Character escape) {
     ...
     */
    public CSVReader(Reader reader, Character separator, Character quotechar, Integer line) {
     ...
     *            the line number to skip for start reading
     */
    public CSVReader(Reader reader, Character separator, Character quotechar, Character escape, Integer line) {
     ...
     *            sets if characters outside the quotes are ignored
     */
    public CSVReader(Reader reader, Character separator, Character quotechar, Character escape, Integer line, Boolean strictQuotes) {
     ...
     */
    public CSVReader(Reader reader, Character separator, Character quotechar, Character escape, int line, boolean strictQuotes, boolean ignoreLeadingWhiteSpace) {
