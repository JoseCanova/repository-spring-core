...
public class BrainzCompoundPredicate<X extends CompoundPredicate, Y> extends  AbstractBrainzPredicate<X> {

	private static final long serialVersionUID = 8338138405597600928L;

	public  BrainzCompoundPredicate(BrainzCriteriaBuilder criteriaBuilder ,X delegatePredicate) {
