...
public class MusicBrainzKnowledgeGraph 
implements InitializingBean{
	...
	Graph<Class<? extends BaseEntity> , PriorityEdge> entityDirectedGraph = MusicBrainzKnowledgeGraph.buildDirectedSimpleGraph();
	...
	public MusicBrainzKnowledgeGraph() {
	}
...
//		.forEach(a ->{
//			addAttributeOnGraph(entityGraph,clazz,c,a);
//		});
